  ...
  <div class="dashboard-page">
    <header class="page-header">
      <div>
        ...
        <p>Configura los detalles principales de tu nuevo infoproducto.</p>
      </div>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-section">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input type="text" id="months" v-model="form.months" required placeholder="Ej: 3" />
            </div>
          </div>
        </div>
        ...
        <div class="form-section">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="promoFile">Video Promocional</label>
          ...
          <div class="form-group checkbox-group">
            <label class="switch-label">
              <input type="checkbox" v-model="form.certificate" />
              ¿Entregar certificado al finalizar?
            </label>
          </div>
        </div>
...
onMounted(async () => {
  try {
    const [catRes, levRes] = await Promise.all([
      infoproductService.getCategories(),
      infoproductService.getLevels()
    ]);
    categories.value = catRes.data?.data || catRes.data || [];
    levels.value = levRes.data?.data || levRes.data || [];
  } catch (error) {
