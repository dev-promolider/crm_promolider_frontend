      ...
      <div class="card condition-card">
        ...
        <ul class="condition-list">
          <li>
            ...
            <CheckCircle2 v-if="widgetsData.conditions.membershipActive" class="text-green" :size="20" />
            <XCircle v-else class="text-red" :size="20" />
          </li>
          <li>
            <span class="cond-label">OPC activos:</span>
            <CheckCircle2 v-if="widgetsData.conditions.active" class="text-green" :size="20" />
            <XCircle v-else class="text-red" :size="20" />
          </li>
          <li>
            <span class="cond-label">Calificado:</span>
            <CheckCircle2 v-if="widgetsData.conditions.qualified" class="text-green" :size="20" />
            <XCircle v-else class="text-red" :size="20" />
          </li>
        </ul>
