...
.loader-overlay {
  ...
  align-items: center;
  background: var(--bg-main, rgba(10, 15, 24, 0.8));
...
.loader {
  --duration: 3s;
  --primary: var(--primary-color, #18d600);
  --primary-light: var(--sidebar-bg, #0b1120);
  --primary-rgba: rgba(24, 214, 0, 0);
  width: 200px;
  height: 320px;
  position: relative;
...
.loader:after {
  ...
  right: 32%;
  bottom: -11px;
  /* background color matching the overlay */
  background: var(--bg-main, #0a0f18);
