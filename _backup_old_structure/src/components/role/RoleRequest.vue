...
export default {
  ...
  methods: {
    ...
    approveDeny(id) {
      ...
      axios.patch(`/config/role-request/confirm-change`, form).then((response) => {
        $('#modalViewRequest').modal('hide');
    ...
    rejectDeny(id) {
      ...
      axios.patch(`/config/role-request/reject-change`, form).then((response) => {
    ...
    listUsers() {
      ...
      api.get(`/config/role-request/list`).then((response) => {
