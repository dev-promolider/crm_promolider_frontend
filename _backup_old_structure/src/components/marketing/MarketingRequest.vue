<template>
    <div>
        <div class="d-flex gap-2 mb-3">
          <el-button type="primary" class="btn btn-primary" native-type="submit" disabled>
            Crear Masterclass
          </el-button>
          <el-button type="primary" class="btn btn-primary" native-type="submit" disabled>
            Crear Mini curso
        ...
        <template v-if="chargeData">
            ...
            <template v-else-if="!data.status">
                <div class="text-center my-5">
                    <p>Se debe solicitar permisos para crear herramientas</p>
            ...
            <div class="modal fade" id="modalViewRequest" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">¿Desea solicitar los permisos para crear herramientas?</div>
...
export default {
    ...
    methods: {
        ...
        async getRequest() {
            await axios.get('/config/role-request-tools/get').then((response) => {
                this.data = response.data;
            });
            this.chargeData = true;
        },
        async changeRole() {
            await axios.post('/users/change-role-tools').then((response) => {
