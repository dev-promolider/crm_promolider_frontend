                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center my-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="96"
                                height="96" viewBox="0 0 172 172" style=" fill:#000000;">
                    ...
                    <div class="modal-footer">
                        <a href="{{ url('/login') }}" type="button" class="btn btn-primary">Ir al inicio</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Modal footer -->
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal">Volver a intentarlo</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        @section('page-script')
            <script>
                function asc_datos(data) {
                    ...
                    document.getElementById('tipo_pago').innerHTML = "Aprovado"
            ...
            <script>
                ...
                paypal.Buttons({
                    ...
                    createOrder: function(data, actions) {
                        return actions.order.create({
                            ...
                            purchase_units: [{
                                amount: {
                                    currency_code: "USD",
                                    value: {{ $data[2]}} // Can also reference a variable or function
                                }
                            }]
                        });
                    },
                    ...
                    onApprove: (data, actions) => {
                        ...
                        return fetch('/pay/recompra-process/'+data.orderID)
                            .then(res => res.json())
