...
@section('vendor-style')
  {{-- Optimización: CSS crítico inline, resto diferido --}}
...
<section id="dashboard-ecommerce">
  ...
  <a href="{{ route('uninivel') }}" class="btn btn-outline-primary btn-sm mr-2">Árbol Uninivel</a>
  <a href="{{ route('binario') }}" class="btn btn-primary btn-sm">Árbol Binario</a>
...
@section('vendor-script')
  {{-- Optimización: defer para scripts no críticos --}}
  <script src="{{ asset(mix('vendors/js/charts/apexcharts.min.js')) }}" defer></script>
  <script src="{{ asset(mix('vendors/js/extensions/toastr.min.js')) }}" defer></script>
@endsection

@section('page-script')
  <script src="{{ asset(mix('js/scripts/pages/dashboard-ecommerce.js')) }}" defer></script>
@endsection