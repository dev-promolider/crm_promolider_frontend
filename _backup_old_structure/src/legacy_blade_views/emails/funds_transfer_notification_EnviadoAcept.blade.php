...
<head>
    ...
    <title>Fondos Transferidos Exitosamente - {{ config('app.name') }}</title>
    <style>
...
<body>
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            <img src="https://promolider-storage-user.s3-accelerate.amazonaws.com/images/promolider_logo.png" alt="Logo" class="logo">
            <h1 class="main-title">¡Fondos Transferidos!</h1>
            <p class="subtitle">Su solicitud ha sido procesada exitosamente</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="transaction-details">
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $remite_nombre }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Destinatario:</span>
                        <span class="detail-value">{{ $destinatario_nombre }} ({{ $destinatario_usuario }})</span>
                    </div>
                    <div class="detail-item">
            ...
            <div style="text-align: center;">
                <a href="{{ route('traslados.historial') }}" class="action-button">Ver Historial de Transferencias</a>
            </div>
        </div>
