...
<head>
    ...
    <title>Acceso a tu E-book</title>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap: break-word; word-break: break-word; padding: 20px 0 30px; font-family: 'Inter', sans-serif;" align="center">
                                                            ...
                                                            <p style="margin: 8px 0 0; color: #bdc3c7; font-size: 16px; font-weight: 400; text-align: center;">
                                                                Tu acceso al e-book está listo
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div style="width: 100% !important;">
                                        <div style="padding: 30px 25px;">
                                            ...
                                            <p style="color: #4a5568; margin: 0 0 25px 0; font-size: 15px; line-height: 1.6;">
                                                Te damos la bienvenida y te confirmamos que tu inscripción ha sido exitosa. 
                                                Estás a un paso de comenzar tu experiencia de lectura.
                                            </p>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #faf5ff; border-radius: 10px; margin: 25px 0; border-left: 4px solid #8b5cf6;">
                                                <tr>
                                                    <td style="padding: 20px;">
                                                        <h2 style="color: #2d3748; font-size: 20px; font-weight: bold; margin: 0 0 12px 0; line-height: 1.3;">{{ $ebook_title }}</h2>

                                                        <!-- Imagen del ebook -->
                                                        @if($ebook->images->first())
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 15px 0;">
                                                            <tr>
                                                                <td align="center">
                                                                    <img src="{{ asset($ebook->images->first()->image) }}" 
                                                                         alt="{{ $ebook_title }}" 
                                                                         width="400" 
                                                                         height="150"
                                                ...
                                                <tr>
                                                    <td style="padding: 20px;">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tr><td style="color: #92400e; font-size: 14px; padding: 4px 0;">• Haz clic en el botón morado para acceder inmediatamente</td></tr>
                                                            <tr><td style="color: #92400e; font-size: 14px; padding: 4px 0;">• El enlace es válido por 90 días completos</td></tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 35px 0;">
                                                <tr>
                                                    <td align="center">
                                                        <table cellpadding="0" cellspacing="0" border="0" style="border-radius: 8px; background-color: #8b5cf6;">
                                                            <tr>
                                                                <td style="border-radius: 8px; background-color: #8b5cf6;">
                                                                    <a href="{{ $pdf_link }}" 
                                            ...
                                            <!-- Detalles del ebook -->
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f0fdf4; border-radius: 8px; margin: 25px 0; border-left: 4px solid #8b5cf6;">
                                                <tr>
                                                    <td style="padding: 20px;">
                                                        <h3 style="color: #6b21a8; font-size: 16px; margin: 0 0 15px 0; font-weight: bold;">📖 Detalles del E-book</h3>
                                                        
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tr>
                                                                <td style="color: #6b21a8; font-size: 14px; padding: 5px 0;">
                                                                    📚 <strong>Título:</strong> {{ $ebook_title }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color: #6b21a8; font-size: 14px; padding: 5px 0;">
                                                                    ✍️ <strong>Autor:</strong> {{ $ebook->author }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color: #6b21a8; font-size: 14px; padding: 5px 0;">
                                                                    📄 <strong>Páginas:</strong> {{ $ebook->pages }} páginas
                                                                </td>
                                                            </tr>
                                                            @if($ebook->category)
                                                            <tr>
                                                                <td style="color: #6b21a8; font-size: 14px; padding: 5px 0;">
                                                                    🏷️ <strong>Categoría:</strong> {{ $ebook->category->name }}
                                                                </td>
                                                            </tr>
                                                            @endif
                                                        </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f9fafb; border-radius: 8px; margin: 25px 0; padding: 25px; border-top: 1px solid #e5e7eb;">
                                                <tr>
                                                    <td style="text-align: center;">
                                                        <p style="color: #6b7280; font-size: 14px; margin: 0 0 8px 0;">Si tienes alguna pregunta o problema para acceder al e-book, no dudes en contactarnos.</p>
                                                        <p style="color: #6b7280; font-size: 14px; margin: 0 0 15px 0;"><strong>¡Esperamos que disfrutes tu lectura!</strong></p>
