...
$(window).on('load', function () {
  ...
  var user_name_notify = document.getElementById("user_name_notify");//
  ...
  setTimeout(function () {
    toastr['success'](
      'Has iniciado sesión correctamente en Promolider. ¡Ya puedes empezar a explorar!',
      '👋 Bienvenido '+user_name_notify.value+"!",
      {
        closeButton: true,
        tapToDismiss: false,
